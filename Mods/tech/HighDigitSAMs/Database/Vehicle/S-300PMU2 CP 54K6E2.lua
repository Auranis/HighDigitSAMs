...
for i = 1,24 do
    ...
    GT.WS[ws].LN[1].depends_on_unit = {{{"S-300PMU1 40B6MD sr",},},{{"S-300PMU1 64N6E sr",},},{{"S-300PS 40B6MD sr",},},{{"S-300PS 64H6E sr",},},{{"S-300PMU2 64H6E2 sr",},},};
end

GT.Name = "S-300PMU2 54K6E2 cp"
GT.DisplayName = _("SAM SA-20B S-300PMU2 CP 54K6E2")
GT.Rate = 20
