-- s-300ps 5p85ce ln for 5v55rud missile
...
GT.WS[ws].LN[1].depends_on_unit = {{{"S-300PS 40B6M tr"},},{{"S-300PMU1 40B6M tr"},},};
...
GT.Name = "S-300PS 5P85CE ln";
GT.DisplayName = _("SAM SA-10 (5V55RUD) S-300PS LN 5P85CE");
GT.Rate = 10;
