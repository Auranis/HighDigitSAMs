...
GT.sensor.max_alt_finding_target = 23000;
...
for i = 1,15 do 
    ...
    GT.WS[ws].LN = 
    {
        {
        type = 103,
		reflection_limit = 0.032, --less sensitive than the GF300
...
GT.Name = "SAMP/T MRI ARABEL";
GT.DisplayName = _("SAM SAMP/T MRI ARABEL");
GT.Rate = 20;
