...
local SA9M82M = {
	...
	H_max = 40000.0, -- Maximum target altitude
	...
	v_mid = 1700.0, -- average speed in m/s
	Mach_max = 8.0, -- maximum Mach of the missile
...
GT_t.WS_t.Antey2500_9M82M.LN[1].distanceMin = 7000
