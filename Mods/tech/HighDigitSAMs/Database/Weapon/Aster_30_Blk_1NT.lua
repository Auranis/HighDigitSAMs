...
local Aster30Blk1NT = {
	Name = Aster30_Blk_1NT, --Aster 30 Block 1NT
	display_name = _('Aster 30 Block 1NT'),
	name = "Aster30Blk1NT",
	...
	{
		{
			name	 = "Aster_30_Blk_1NT";
			file  	 = "Aster_30_Blk_1NT";
			life  	 = 1;
			fire  	 = { 0, 1};
			username = "Aster30Blk1NT";
			index = WSTYPE_PLACEHOLDER;
		},
	}
};
declare_weapon(Aster30Blk1NT)

GT_t.WS_t.SAMPTNG = {} -- SAMP/T Launcher using the Aster 30 Block 1NT
GT_t.WS_t.SAMPTNG.moveable = false
GT_t.WS_t.SAMPTNG.angles = {
					{math.rad(180), math.rad(-180), math.rad(-90), math.rad(90)},
					};
GT_t.WS_t.SAMPTNG.reference_angle_Z = math.rad(90)
GT_t.WS_t.SAMPTNG.LN = {}
GT_t.WS_t.SAMPTNG.LN[1] = {}
GT_t.WS_t.SAMPTNG.LN[1].type = 4
GT_t.WS_t.SAMPTNG.LN[1].distanceMin = 3000
GT_t.WS_t.SAMPTNG.LN[1].distanceMax = 120000
GT_t.WS_t.SAMPTNG.LN[1].ECM_K = 0.4;
GT_t.WS_t.SAMPTNG.LN[1].reactionTime = 2
GT_t.WS_t.SAMPTNG.LN[1].launch_delay = 2;
GT_t.WS_t.SAMPTNG.LN[1].reflection_limit = 0.029; --Same as 30N6E2 (S-300PMU1) & AN/MPQ-53 (Patriot PAC-1)
GT_t.WS_t.SAMPTNG.LN[1].sensor = {}
set_recursive_metatable(GT_t.WS_t.SAMPTNG.LN[1].sensor, GT_t.WSN_t[0])
GT_t.WS_t.SAMPTNG.LN[1].beamWidth = math.rad(1);
GT_t.WS_t.SAMPTNG.LN[1].PL = {}
GT_t.WS_t.SAMPTNG.LN[1].PL[1] = {}
GT_t.WS_t.SAMPTNG.LN[1].PL[1].ammo_capacity = 8
GT_t.WS_t.SAMPTNG.LN[1].PL[1].type_ammunition = Aster30Blk1NT.wsTypeOfWeapon;
GT_t.WS_t.SAMPTNG.LN[1].PL[1].reload_time = 1000000; -- never during the mission for the WS, reload handled in the relevant LN file.
GT_t.WS_t.SAMPTNG.LN[1].max_number_of_missiles_channels = 2;
GT_t.WS_t.SAMPTNG.LN[1].BR = { {pos = {0, 0, 0} } }